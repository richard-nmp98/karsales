...
export function useGetPostDetailQuery(
	baseOptions?: ApolloReactHooks.QueryHookOptions<GetPostDetailQueryResponse, GetPostDetailQueryVariables>,
) {
	return ApolloReactHooks.useQuery<GetPostDetailQueryResponse, GetPostDetailQueryVariables>(
		GetPostDetailDocument,
		baseOptions,
	);
}
export function useGetPostDetailLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetPostDetailQueryResponse, GetPostDetailQueryVariables>,
) {
	return ApolloReactHooks.useLazyQuery<GetPostDetailQueryResponse, GetPostDetailQueryVariables>(
		GetPostDetailDocument,
		baseOptions,
	);
}
...
export type GetPostDetailQueryResult = ApolloReactCommon.QueryResult<
	GetPostDetailQueryResponse,
