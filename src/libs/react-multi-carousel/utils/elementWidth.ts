import type { ResponsiveType, CarouselProps } from '../types';
...
function getWidthFromDeviceType(deviceType: string, responsive: ResponsiveType): number | string | undefined {
	let itemWidth;
...
function getItemClientSideWidth(props: CarouselProps, slidesToShow: number, containerWidth: number): number {
