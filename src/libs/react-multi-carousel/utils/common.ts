...
import type { CarouselInternalState, CarouselProps } from '../types';
...
function getTransformForCenterMode(state: CarouselInternalState, props: CarouselProps, transformPlaceHolder?: number) {
